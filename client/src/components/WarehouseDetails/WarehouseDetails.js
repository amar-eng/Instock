    ...
    return (
        <section className="warehouse-details">
            <div className="warehouse-details__address">
                ...
                <address className="warehouse-details__text">{address}, <br />{city}, {country}</address>
            </div>
            <div className="warehouse-details__contact-name">
                <h3 className="warehouse-details__heading">CONTACT NAME:</h3>
                <div className="warehouse-details__text">{contact.name} <br />{contact.position}</div>
            </div>
            <div className="warehouse-details__contact-info">
                <h3 className="warehouse-details__heading">CONTACT INFORMATION:</h3>
                <div className="warehouse-details__text">{contact.phone}<br />{contact.email}</div>
            </div>
        </section>
    )
}